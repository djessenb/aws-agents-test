...
def main():
    ...
    with streamable_http_mcp_client:
        ...
        agent = Agent(system_prompt=system_prompt, tools=tools, model="anthropic.claude-3-5-sonnet-20240620-v1:0")
        ...
        while True:
            ...
            print("\nThinking...\n")
            response = agent(user_input, model="anthropic.claude-3-5-sonnet-20240620-v1:0")
